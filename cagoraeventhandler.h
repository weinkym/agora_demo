#ifndef CAGORAEVENTHANDLER_H
#define CAGORAEVENTHANDLER_H
...
class CAGEngineEventHandler : public QObject,
...
signals:
    void sigJoinChannelSuccess(const char* channel, uid_t uid, int elapsed);
    void sigFirstRemoteVideoDecoded(uid_t uid, int width, int height, int elapsed);
    void sigUserOffline(uid_t uid, int reason);


};
#endif // CAGORAEVENTHANDLER_H
